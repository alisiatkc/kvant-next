...
export default function AIAssistant() {
  ...
  const openChat = useCallback(() => {
    ...
    if (!greeted) {
      setGreeted(true)
      setTimeout(() => {
        addBotMessage('👋 Привет! Я Квант, твой ИИ-помощник. Спрашивай о проектной практике, планировании, апробации, адаптации результата в КОП, мастер-классах или контактах.', false)
      }, 300)
    }
